<template>
    <div class="flex items-center justify-between mb-3">
        ...
        <button @click="showProductModal" type="submit"
                class="flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-offset-2 focus:ring-indigo-500">
            Add new Product
        </button>
    </div>
